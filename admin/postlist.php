		...
		<div class="container">
			...
			<div class="row">
				<div class="col dashboard">
					<h2 class="text-center m-2 " style="font-family:cursive; height:50px;">Postlist</h2>
					<hr>
                            ...
                            ?>
								<tbody>
									<tr>
										...
										<td>
											<a onclick="return confirm('Are you sure to delete')" class="btn btn-danger pb-sm-2" href="delpost.php?id=<?php echo $result['id'];?> ">Delete</a>
											<a href="updatepost.php?id=  <?php echo $result['id'];?>" class="btn btn-primary mt-2">Update</a>
										</td>
									</tr>
								</tbody>
								<?php } }?>
