...
<body>
    ...
    <section id="semester">
        <div class="container">
            <div class="row my-3">
                <?php
                $sql = "select * from sell where status = '0' and semester='2' limit $start_from,$per_page";
    ...
    ?>
        <nav aria-label="Page navigation example ">
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" href="semester2.php?page=0" aria-label="Previous">
            ...
            ?>
                <li class="page-item"><a class="page-link" href="semester2.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
                <?php } } ?>
                <li class="page-item">
                    <a class="page-link" href="semester2.php?page=<?php echo $total_pages;?>" aria-label="Next">
