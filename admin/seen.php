       ...
       <div class="container">
        <div class="row">
            <div class="col-md-8   my-2">
               <h2 class="text-center my-2">Seen Box</h2>
               <hr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else {?>
                                        <a  class="btn btn-secondary " href="delseen.php">viewed</a>
                                        <a href="reply.php?rep_id= <?php echo $result['id'];?>" class="btn btn-primary my-2">Reply</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            </tbody>
