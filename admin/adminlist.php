        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col dashboard">
                    <h2 class="text-center m-2 " style="font-family:cursive; height:50px;">Admin List</h2>
                    <hr>
                        ...
                        <div class="table-responsive">
                            ...
                            ?>
                                <tbody>
                                    ...
                                    ?>
                                            <a onclick="return confirm('Are you sure to delete')" class="btn btn-danger pb-sm-2" href="deladmin.php?id=<?php echo $result['id'];?> ">Delete</a>
                                            <a href="updateadmin.php ?id=  <?php echo $result['id'];?>" class="btn btn-primary m-2">Update</a>
                                    <?php }
                                    ?>
