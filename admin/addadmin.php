...
<?php
    ...
    {
        $sql ="insert into tbl_user(name,email,password,role) values('$name','$email','$password','$role')";
        $user = $db->insert($sql);
        if($user)
        {
            $msg = "User added successfully.Thank you";

        }
        else
        {
            $error = "Something wrong.User can't be not added.";               
        }
    }
    }
?>
                    ...
                    <form action="" method="post">
                        <div class="card  bg-dark text-center my-2 uk-animation-scale-down">
                            ...
                            <div class="card-footer">
                                <button class="btn btn-block btn-success" name="update">Add</button>
                            </div>
                        </div>
                    </form>
                </div>
